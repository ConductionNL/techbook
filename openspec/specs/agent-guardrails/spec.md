...
- **Creatie-regel (2026-07-10, uit de eerste livetest):** operaties die
  nieuwe infrastructuur-entiteiten aanmaken zijn "voorstel-eerst" — de
  agent toont het volledige voorstel en schrijft pas na expliciet
  akkoord in de sessie. Zie handbook org/agents.md.
