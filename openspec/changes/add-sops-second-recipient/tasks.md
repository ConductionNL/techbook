...
- [ ] 1.3 MENS: `sops updatekeys` per *.sops.yaml draaien (alleen talos:
      `runner-conn.sops.yaml`, `runner-oci-conn.sops.yaml` — monitoring
      heeft nog geen echt versleuteld bestand); commit
